<template>
    <div>
        <Layout>
            ...
            <div class="row">
                <Link :href="route('admin.additional-courses.create')"><button class="btn btn-success float-end"><font-awesome-icon icon="fa-solid fa-circle-plus" /> Create</button></Link>
