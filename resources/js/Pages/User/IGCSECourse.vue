    ...
    <Layout>
        ...
        <section class="container my-6">
            <div v-for="igcse in igcseCourses" :key="igcse.id" class="mb-8">
                <div class="max-w-lg mx-auto rounded-lg overflow-hidden shadow-lg">
                    ...
                    <div class="p-4">
                        ...
                        <p>Duration: {{ igcse.duration }} months</p>
                        <p>Monthly Price: {{ igcse.price_monthly }} Ks</p>
                    </div>
                </div>

                <p class="text-xl py-2 text-center font-semibold mt-4">Subjects</p>
